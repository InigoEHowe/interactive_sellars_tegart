...
sliderSigmaP = Slider(title="SigmaP", value=SigmaP, start=0.0, end=50.0,step=0.1)
sliderSigmaR = Slider(title="SigmaR", value=SigmaR, start=0.0, end=50.0,step=0.1)
sliderQ = Slider(title="Q", value=Q, start=0.5e5, end=3e5,step=1e3)
sliderA = Slider(title="A", value=A, start=1.00e7, end=1.00e9,step=1.00e7)
slidern = Slider(title="n", value=n, start=3, end=6,step=0.1)
